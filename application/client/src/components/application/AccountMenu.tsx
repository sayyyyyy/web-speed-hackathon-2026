    ...
    >
      ...
      >
        <img
          ...
          src={`${getProfileImagePath(user.profileImage.id)}?w=40`}
          srcSet={`${getProfileImagePath(user.profileImage.id)}?w=40 1x, ${getProfileImagePath(user.profileImage.id)}?w=80 2x`}
          sizes="40px"
          loading="lazy"
          decoding="async"
          width={40}
