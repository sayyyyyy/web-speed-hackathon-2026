...
export const SoundPlayer = ({ sound }: Props) => {
  ...
  return (
    <div className="bg-cax-surface-subtle flex h-full w-full items-center justify-center">
      <audio preload="none" ref={audioRef} loop={true} onTimeUpdate={handleTimeUpdate} src={getSoundPath(sound.id)} />
      <div className="p-2">
        <button
        ...
        <div className="pt-2">
          <AspectRatioBox aspectHeight={1} aspectWidth={10}>
            <div className="relative h-full w-full">
              ...
              <div
                className="bg-cax-surface-subtle absolute inset-0 h-full w-full opacity-75 pointer-events-none transition-all duration-100 ease-linear"
